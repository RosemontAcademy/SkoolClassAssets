...
const CHARACTERS = {
  ...
  venonat: {
    ...
    hitAction: 'the psychic ring collapses inward, the warp snaps back then fades',
  },
  venomoth: {
    spriteId: 49, canvasSize: 256,
    attackAction:  'venomoth, big purple moth with wide dusty wings, at the bottom-left corner, stays fully visible in every frame, it beats its wings and sends stacked pale green sound rings buzzing toward the top-right corner, side view',
    attackedAction:'venomoth, big purple moth with wide dusty wings, at the top-right corner facing the viewer, stays fully visible in every frame, it beats its wings and sends stacked pale green sound rings buzzing toward the bottom-left corner, front view',
    hitColor: 0x9BD44AFF, hitShape: 'circle', elemental: true,
    hitDescription: 'bug buzz impact, concentric pale green sound rings hammer the target, the air shivers, green dust motes shake loose, pixel art',
    hitAction: 'sound rings pulse outward one after another, dust motes shake loose and fade',
  },
  diglett: {
    spriteId: 50, canvasSize: 128,
    attackAction:  'diglett, tiny brown mole poking out of the ground, at the bottom-left corner, stays fully visible in every frame, it flings a spray of wet brown mud clods that arc toward the top-right corner, side view',
    attackedAction:'diglett, tiny brown mole poking out of the ground, at the top-right corner facing the viewer, stays fully visible in every frame, it flings a spray of wet brown mud clods that arc toward the bottom-left corner, front view',
    hitColor: 0x8B5A2BFF, hitShape: 'scatter', elemental: false,
    hitDescription: 'mud-slap impact, wet brown mud splatters across the target, thick clods stick and slide down, dirt specks fly outward, pixel art',
    hitAction: 'mud splatters outward, clods slide down and dirt specks scatter then fade',
  },
  dugtrio: {
    spriteId: 51, canvasSize: 128,
    attackAction:  'dugtrio, three brown mole heads side by side in the soil, at the bottom-left corner, stays fully visible in every frame, the ground splits and jagged brown rock shards burst upward along a widening crack running to the top-right corner, side view',
    attackedAction:'dugtrio, three brown mole heads side by side in the soil, at the top-right corner facing the viewer, stays fully visible in every frame, the ground splits and jagged brown rock shards burst upward along a widening crack running to the bottom-left corner, front view',
    hitColor: 0xA9743AFF, hitShape: 'scatter', elemental: true,
    hitDescription: 'earthquake impact, the ground under the target cracks apart, brown rock shards jolt upward and dust bursts out, pixel art',
    hitAction: 'the crack snaps open, shards jolt up then fall back as dust settles',
  },
  meowth: {
    spriteId: 52, canvasSize: 128,
    attackAction:  'meowth, cream coloured cat with a gold coin on its forehead, at the bottom-left corner, stays fully visible in every frame, it swipes a paw and flings a shower of spinning gold coins that fly toward the top-right corner, side view',
    attackedAction:'meowth, cream coloured cat with a gold coin on its forehead, at the top-right corner facing the viewer, stays fully visible in every frame, it swipes a paw and flings a shower of spinning gold coins that fly toward the bottom-left corner, front view',
    hitColor: 0xF2C230FF, hitShape: 'scatter', elemental: false,
    hitDescription: 'pay day impact, gold coins clatter against the target and bounce off spinning, small yellow sparkles pop at each hit, pixel art',
    hitAction: 'coins strike and bounce off spinning, sparkles pop then the coins fall away',
  },
  persian: {
    ...
    hitAction: 'three gashes rip across, edges flash then sparks fly along the cuts and fade',
  },
  psyduck: {
    spriteId: 54, canvasSize: 128,
    attackAction:  'psyduck, yellow duck holding its head, at the bottom-left corner, stays fully visible in every frame, it opens its beak and shoots a thin arcing jet of blue water toward the top-right corner with droplets trailing behind, side view',
    attackedAction:'psyduck, yellow duck holding its head, at the top-right corner facing the viewer, stays fully visible in every frame, it opens its beak and shoots a thin arcing jet of blue water toward the bottom-left corner with droplets trailing behind, front view',
    hitColor: 0x4AA8E8FF, hitShape: 'circle', elemental: true,
    hitDescription: 'water gun impact, a jet of blue water bursts against the target, spray fans out in a ring, droplets scatter, pixel art',
    hitAction: 'the jet bursts, spray fans out then droplets scatter and fall',
  },
  golduck: {
    spriteId: 55, canvasSize: 128,
    attackAction:  'golduck, blue duck with a red gem on its forehead, at the bottom-left corner, stays fully visible in every frame, it thrusts both webbed hands forward and blasts a thick spiralling torrent of blue water toward the top-right corner, side view',
    attackedAction:'golduck, blue duck with a red gem on its forehead, at the top-right corner facing the viewer, stays fully visible in every frame, it thrusts both webbed hands forward and blasts a thick spiralling torrent of blue water toward the bottom-left corner, front view',
    hitColor: 0x2E86DEFF, hitShape: 'circle', elemental: true,
  ...
  paras: {
    ...
    attackedAction:'paras, small orange mushroom crab, sits at the top-right corner facing the viewer and stays fully visible in every frame, it swipes both front claws downward-left, leaving three bright white glowing claw streaks that fly toward the bottom-left corner, front view',
    hitColor: 0xE8703AFF, hitShape: 'scatter', elemental: false,
    hitDescription: 'scratch impact, three thin white claw marks rake across the target, small orange chips fly off, pixel art',
    hitAction: 'three claw marks rake across, chips scatter outward then fade',
  },
  parasect: {
    ...
    hitAction: 'two green blades sweep across each other in an X, the crossing flashes then shards fly along both lines and fade',
  },
  oddish: {
